...
namespace RentHouse.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            IdentityRole identityRole1 = new IdentityRole("ManagerUser");
            await _roleManager.CreateAsync(identityRole1);
            IdentityRole identityRole2 = new IdentityRole("Admins");
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (await _userReponsitory.CheckUserName(Input.Username))
                {
                    ModelState.AddModelError("Input.Username", "Already Exist");
                }
                else
                {
                    ...
                    var result = await _userManager.CreateAsync(userApplicationUser, Input.Password);
                    if (result.Succeeded)
                    {
                        _logger.LogInformation("User created a new account with password.");
                        IdentityUser aUser = await _userManager.FindByEmailAsync(Input.Email);
                        ...
                        {
                            await _signInManager.SignInAsync(userApplicationUser, isPersistent: false);
